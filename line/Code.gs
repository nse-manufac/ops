...
// รอบแรกตอนเปิดเรื่องนับเป็น 1 อยู่แล้ว เพดานที่นั่นจึงเป็น 4 + 1 = 5
// ถ้าตั้งตรงนี้สูงกว่า พนักงานจะพิมพ์คำตอบที่ไม่มีใครอ่านแล้วไม่รู้ตัว
//
// ขยับจาก 2 เป็น 4 เมื่อ 25 ส.ค. 2026 เพราะของจริงตันก่อนหัวหน้าทีมได้ทำงานจริง
// สาเหตุหลักคือฝั่ง workflow นับข้อความ "ทำงานไม่สำเร็จ" เป็นรอบด้วย (แก้ไปแล้ว)
// แต่สองรอบก็น้อยเกินไปอยู่ดีสำหรับเรื่องที่มีหลายอาการปนกัน — issue #35 เป็นตัวอย่าง
const MAX_REPLY   = 4;
